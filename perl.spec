...
ist. Die Sprache eignet sich auъerdem fЭr viele
...
rapports basИs sur ces informations. C'est aussi un bon langage pour
de nombreuses procИdures de gestion systХme. Ce langage se veut
pratique (simple Ю utiliser, efficace, complet) autant qu'agrИable
(conscrit, ИlИgant, minimal).

%description -l pl
Perl jest jЙzykiem przeznaczonym do skanowania plikСw tekstowych,
wyci╠gania z nich informacji i drukowania raportu bazuj╠cego na tych
informacjach. Jest rСwnie© doskonaЁym jЙzykiem do wielu prac
zwi╠zanych z nadzorem systemu. JЙzyk ten jest w zamierzeniu bardziej
...
yorumlamalЩ dildir. AyrЩca pek Гok sistem yЖnetimi gЖrevleri iГin de
yararlЩ yetenekleri vardЩr. Perl, gЭzel (ufak, zarif, minimum)
